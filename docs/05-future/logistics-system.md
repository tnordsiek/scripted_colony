...
Dieses Dokument bewahrt nicht-MVP-verbindliche Logistikdetails. Sie sind bewusst aus den MVP-Aktivregeln abgegrenzt.

```text
Nicht MVP-verbindlich.
Nicht implementieren, außer eine Aufgabe verweist ausdrücklich darauf.
```
...
2. bei Gleichstand seeded random nach `../03-technical/seeded-rng.md`
```
